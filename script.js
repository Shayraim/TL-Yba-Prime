            ...
            <header className="hero-section container">
                <div className="profile-header">
                    <div className="profile-content">
                        ...
                        <div className="disclaimer-box"><p><strong>Disclaimer:</strong> This tier list is <strong>not to be taken seriously</strong>. It changes every week based on performance.</p></div>
                    </div>
                </div>
